...
# Greek nouns inflect (αφλατοξίνη → αφλατοξινών gen.pl.), so we include
# stems (root without case ending) to match all inflected forms.
MICROBIAL_TOXINS = {
    # Aflatoxin — stem 'αφλατοξιν' covers η/ες/ης/ων/ας inflections
...
NATURAL_TOXINS = {
    ...
    "scombroid", "histamine poisoning",  # histamine as natural fish toxin context
    "lectin", "ricin", "ρικίνη",
...
SYNTHETIC_CHEMICALS = {
    "coumarin", "κουμαρίνη", "κουμαρινη",
    "pesticide", "φυτοφάρμακο", "φυτοφαρμακο",
    "chlorpyrifos", "χλωροπυριφός",
    "glyphosate", "γλυφοσάτη",
    "additive", "πρόσθετο", "προσθετο",
    "preservative over limit", "συντηρητικό υπέρβαση",
    "colorant over limit", "χρωστική υπέρβαση",
    "nitrite over limit", "νιτρώδη υπέρβαση",
    "nitrate over limit", "νιτρικά υπέρβαση",
    "sudan dye", "sudan i", "sudan ii", "sudan iii", "sudan iv",
    "rhodamine", "ροδαμίνη",
    "ethylene oxide", "οξείδιο αιθυλενίου",
    "melamine", "μελαμίνη",
...
# REJECT — heavy metals
HEAVY_METALS = {
    "cadmium", "κάδμιο", "καδμιο",
    "lead", "μόλυβδος", "μολυβδος",
    "mercury", "υδράργυρος", "υδραργυρος",
    "arsenic", "αρσενικό", "αρσενικο",
    "chromium", "χρώμιο", "χρωμιο",
    "nickel", "νικέλιο", "νικελιο",
    "tin", "κασσίτερος", "κασσιτερος",
    "heavy metal", "βαρύ μέταλλο", "βαρυ μεταλλο",
}

# REJECT — foreign matter
FOREIGN_MATTER = {
    "glass", "γυαλί", "γυαλι", "verre",
    "metal fragment", "θραύσμα μετάλλου", "μέταλλο", "μεταλλο",
    "plastic", "πλαστικό", "πλαστικο",
