    ...
    "updated_weeks": [
      {
        ...
        "report_url": "https://food-safety-horizon-scan.vercel.app/.../2026-W17.html",
...
REPORT_URL_BASE = "https://food-safety-horizon-scan.vercel.app"
LOOKBACK_WEEKS = 4
...
def main() -> int:
    ...
    INDEX_DASHBOARD_URL = "https://food-safety-horizon-scan.vercel.app/#weekly"
    if len(updated) == 1:
        primary_cta = {
